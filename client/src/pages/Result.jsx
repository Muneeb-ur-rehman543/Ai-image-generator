   ...
   {!isImageLoaded && 
    <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0-5 mt-10 rounded-full'>
      ...
      onChange={(e) => setInput(e.target.value)} value={input}
        ...
        className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder:text-gray-200' 
        value={input}
...
<div className='flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full'>
  <p onClick={()=>{setIsImageLoaded(false)}} className='bg-transparent border border-zinc-900 text-black px-8 py-3 rounded-full cursor-pointer'>Generated Another</p>
